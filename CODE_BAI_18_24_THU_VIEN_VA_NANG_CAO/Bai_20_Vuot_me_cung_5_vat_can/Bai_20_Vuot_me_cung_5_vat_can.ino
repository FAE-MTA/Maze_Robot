...
// BÀI 20: VƯỢT MÊ CUNG BẰNG SIÊU ÂM VÀ HAI LASER
...
void xuLyMotLanVatCan(const DuLieuKhoangCach &d) {
  ...
  if (soLanGapVatCan >= SO_LAN_VAT_CAN_DE_THOAT) {
    dungRobot();
    daRaKhoiMeCung = true;
    oledThongBao("BAI 20 - ME CUNG", "DA GAP 5 VAT CAN",
...
void setup() {
  ...
  sieuAmBatDau();
  laserBatDau();
  oledThongBao("BAI 20 - ME CUNG", "DAT ROBOT DAU LOI",
